...
description: [קמפיינר 10X] מחקר שוק ומתחרים. מוצא מתחרים, שולף מודעות פעילות דרך Apify, מוריד קריאייטיבים (תמונות + וידאו), קורא דפי נחיתה, מנתח זוויות/קריאייטיבים/הצעות, ומוצא פערים והזדמנויות. אופציה לתמלול וידאו דרך Replicate.
