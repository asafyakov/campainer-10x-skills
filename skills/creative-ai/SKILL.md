---
name: creative-ai
description: [קמפיינר 10X] מייצר קריאייטיבים למודעות פייסבוק/אינסטגרם דרך KIE AI. שני מצבים — מאפס (חומרים שיווקיים) או מווינרים (סוכן analytics ברקע). שימור פנים, QA אוטומטי, 4 וריאציות לכל זווית.
